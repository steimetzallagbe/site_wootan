...
if ( ( defined( 'FW' ) ) && ! ( class_exists( 'Dotdigital_Widget_Socials_2' ) ) ) :

	class Dotdigital_Widget_Socials_2 extends WP_Widget {
		...
		function __construct() {
			...
			$widget_ops = array(
				'classname'   => 'widget_socials_2',
				'description' => esc_html__( 'Add socials links', 'dotdigital' ),
			);

			parent::__construct( false, esc_html__( 'Theme - Socials 2', 'dotdigital' ), $widget_ops );
		...
		function widget( $args, $instance ) {
			...
			$filepath = get_template_directory() . '/inc/widgets/socials-2/views/widget.php';
