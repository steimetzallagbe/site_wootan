...
<div class="wrap">
	...
	<h2><?php _e( 'Hire Us - Get unlimited expert WordPress Support and Development', 'accordion-and-accordion-slider' ); ?></h2><br />

	<div class="support-data">
	<h3 style="margin-bottom:5px;"><?php _e( 'Highlight of Hiring:', 'accordion-and-accordion-slider' ); ?></h3>
		<ul>
