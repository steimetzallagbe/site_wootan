										...
										<tbody>
											...
											<tr>
												...
												<td>
													...
													<a class="button button-primary" href="https://demo.wponlinesupport.com/accordion-and-accordion-slider-demo/" target="_blank"><?php _e('Domo Link', 'accordion-and-accordion-slider'); ?></a>	
												</td>
											</tr>
										</tbody>
									</table>
						...
						<div class="meta-box-sortables ui-sortable">
							<div class="postbox" style="">
								...
								<div class="inside">										
									...
									<a class="button button-primary wpos-button-full" href="https://www.wponlinesupport.com/wp-plugin/accordion-accordion-slider/?ref=WposPratik&utm_source=WP&utm_medium=Accordion-Slider&utm_campaign=Upgrade-PRO" target="_blank"><?php  _e('Go Premium ', 'accordion-and-accordion-slider'); ?></a>
									<p><a class="button button-primary wpos-button-full" href="https://demo.wponlinesupport.com/prodemo/accordion-and-accordion-slider-pro-demo/" target="_blank"><?php  _e('View PRO Demo ', 'accordion-and-accordion-slider'); ?></a></p>
								</div><!-- .inside -->
							</div><!-- #general -->
						</div><!-- .meta-box-sortables ui-sortable -->
					</div><!-- .metabox-holder -->
