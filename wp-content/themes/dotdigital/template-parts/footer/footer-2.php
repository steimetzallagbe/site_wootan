...
<?php if( is_active_sidebar('sidebar-1-footer-alt') || is_active_sidebar('sidebar-2-footer-alt') || is_active_sidebar('sidebar-3-footer-alt') ) :?>
    <footer id="footer" class="page_footer footer-2 section_padding_top_100 section_padding_bottom_150 columns_padding_25 <?php echo esc_attr(!empty($footer_colors) ? $footer_colors : 'ds' ); ?>"  <?php echo !empty( $footer_image['url'] ) ? ' style="background-image: url('. esc_url( $footer_image['url']) .')"' : ' ' ?>>
        <div class="container">
