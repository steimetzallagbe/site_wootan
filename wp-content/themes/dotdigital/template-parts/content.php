...
if ( is_singular() ) :
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class('vertical-item content-padding with_background big-padding'); ?>>
        ...
        <div class="item-content">
            <?php if ( ! defined( 'FW' ) ) : ?>
                <div  class="categories-links bottommargin_20 theme_buttons color color1 small_height"><?php echo get_the_category_list( _x( ' ', 'Used between list items, there is a space after the comma.', 'dotdigital' ) ); ?></div>
