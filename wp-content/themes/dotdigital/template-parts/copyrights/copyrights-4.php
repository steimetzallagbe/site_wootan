...
?>
<section class="<?php echo esc_attr(!empty($copyrights_colors) ? $copyrights_colors : 'ds' ); ?> page_copyright page_copyright_4 section_padding_15" <?php echo !empty( $footer_image['url'] ) ? ' style="background-image: url('. esc_url( $footer_image['url']) .')"' : ' ' ?>>
