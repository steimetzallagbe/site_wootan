	...
	'testimonials_group' => array(
		...
		'picker'  => array(
			'testimonials_layout' => array(
				...
				'choices' => array(
					...
					'testimonials_single_carousel_2'         => esc_html__( 'Testimonials Single Carousel 2', 'dotdigital' ),
		...
		'choices' => array(
			...
			'testimonials_single_carousel'         => array(
                ...
                'carousel_nav' => array(
                    'type'         => 'switch',
                    'label'        => esc_html__( 'Carousel Navigation', 'dotdigital' ),
                    'value' => 'false',
                    'left-choice'  => array(
                        'value' => 'false',
                        'label' => esc_html__( 'No', 'dotdigital' ),
                ...
                'nav_variant' => array(
                    'type'         => 'select',
                    'value'        => '',
                    'label'        => esc_html__( 'Navigation variants', 'dotdigital' ),
                    'choices' => array(
                        ''  => esc_html__( 'Variant 1', 'dotdigital' ),
                        'owl-nav-variant-2' => esc_html__( 'Variant 2', 'dotdigital' ),
                    ),
                ),
				'autoplay_timeout' => array(
					'type'  => 'text',
            ...
            'testimonials_single_carousel_2'       => array(
                'carousel_autoplay' => array(
                    'type'         => 'switch',
                    'label'        => esc_html__( 'Carousel Autoplay', 'dotdigital' ),
                    'value' => 'true',
