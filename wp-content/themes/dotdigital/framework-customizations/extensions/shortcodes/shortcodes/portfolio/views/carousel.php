...
$big_center_slide  = isset( $atts['big_center_slide'] ) && $atts['big_center_slide'] == 'true' ? 'big-center-slide' : false;
$nav_layout  = isset( $atts['nav_layout'] ) && $atts['nav_layout'] == 'true' ? 'nav-layout-2' : false;
...
<div id="widget_portfolio_carousel_<?php echo esc_attr( $unique_id ); ?>"
     class="owl-carousel portfolio-shortcode <?php echo esc_attr($big_center_slide . ' ' . $nav_layout) ?>"
     data-loop="1"
     ...
     data-nav="<?php echo esc_html($show_nav) ?>"
