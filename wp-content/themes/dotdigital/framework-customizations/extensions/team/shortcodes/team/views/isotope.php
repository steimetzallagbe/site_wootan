...
$team_variant = ($loop_item === '3') ? 'team-variant-3' : '';
...
<div class="<?php echo esc_attr( $margin_class ); ?>">
	<div class="isotope_container isotope row masonry-layout shortcode-team <?php echo esc_attr( $show_excerpt.' '.$show_socials . ' ' . $team_variant ); ?>"
