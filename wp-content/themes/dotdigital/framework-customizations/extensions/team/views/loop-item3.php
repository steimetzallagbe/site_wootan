...
?>
<div class="vertical-item overflow-hidden team-layout-absolute">
    ...
    <div class="ds">
        <div class="item-content">
            ...
            <?php if ( ! empty( $atts['position'] ) ) : ?>
                <p class="position lightfont fontsize_12 text-uppercase"><?php echo wp_kses_post( $atts['position'] ); ?></p>
            <?php endif; //position ?>
